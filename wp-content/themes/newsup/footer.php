        ...
        <div class="overlay" style="background-color: <?php echo esc_attr($newsup_footer_overlay_color);?>;">
                ...
                <div class="mg-footer-copyright">
                    ...
                    if($newsup_enable_footer_menu == true){ ?>
                            ...
                            <?php } ?>
                                <p>
                                <a href="<?php echo esc_url( __( 'https://www.facebook.com/anurag.rudra.33', 'newsup' ) ); ?>">
								<?php
								/* translators: placeholder replaced with string */
								printf( esc_html__( 'Proudly powered by %s', 'newsup' ), 'Anurag Rudra.' );
								?>
								</a>
								<span class="sep"> | </span>
								<?php
								/* translators: placeholder replaced with string */
								printf( esc_html__( 'Design with %2$s.', 'newsup' ), 'Newsup', '<a href="' . esc_url( __( 'https://techbehemoths.com/company/world-wide-soft-technology', 'newsup' ) ) . '" rel="designer">World Wide Soft Technology and Essuz Corporation.</a>' );
								?>
								</p>
                            </div>
